    ...
    <div class="container py-4">
                ...
                <div class="row py-5">
                    ...
                    <div class="col-md-4 mb-3 mb-md-0">
                        <h6 class="text-uppercase">Всё для читателей</h6>
                        <ul class="list-unstyled">
                            <li><a class="footer-link" href="#"> Помощь &amp; Написать нам </a></li>
                            <li><a class="footer-link" href="#"> Обмен &amp; Возврат </a></li>
                            <li><a class="footer-link" href="#">Он-лайн магазин</a></li>
                            <li><a class="footer-link" href="#">Электронные &amp; аудио книги</a></li>
                        </ul>
                    </div>
                    <div class="col-md-4 mb-3 mb-md-0">
                        <h6 class="text-uppercase">О нас</h6>
                        <ul class="list-unstyled">
                            <li><a class="footer-link" href="#">Чем мы занимаемся</a></li>
                            <li><a class="footer-link" href="#">Доступные услуги</a></li>
                            <li><a class="footer-link" href="#">Публичная оферта</a></li>
